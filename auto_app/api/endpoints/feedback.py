...
from auto_app.db.schema import FeedbackSchema
...
@feedback_router.put('/{feedback_id}', response_model=FeedbackSchema)
async def feedback_update(feedback_id: int, feedback: FeedbackSchema, db: Session = Depends(get_db)):
